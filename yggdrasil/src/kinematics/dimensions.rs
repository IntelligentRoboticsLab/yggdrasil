...
pub const SHOULDER_CAP_TO_SHOULDER_CAP_FRONT: Vector3<f32> = Vector3::new(0.01, 0.0, 0.0);
pub const SHOULDER_CAP_TO_SHOULDER_CAP_BACK: Vector3<f32> = Vector3::new(-0.01, 0.0, 0.0);
