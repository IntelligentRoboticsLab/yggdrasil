...
impl Kinematics {
	...
	#[must_use]
	pub fn left_upper_arm_to_shoulder(left_shoulder_roll: f32) -> Isometry3<UpperArm<Left>, Shoulder<Left>> {
		na::Isometry3::rotation(
		    na::Vector3::z() * left_shoulder_roll
		).into()
	}
	...
	#[must_use]
	pub fn right_upper_arm_to_shoulder(right_shoulder_roll: f32) -> Isometry3<UpperArm<Right>, Shoulder<Right>> {
		na::Isometry3::rotation(
		    na::Vector3::z() * right_shoulder_roll
		).into()
	}

	#[must_use]
	pub fn right_elbow_to_upper_arm(right_elbow_yaw: f32) -> Isometry3<Elbow<Right>, UpperArm<Right>> {
		na::Isometry3::new(
	...
	#[must_use]
	pub fn right_forearm_to_elbow(right_elbow_roll: f32) -> Isometry3<Forearm<Right>, Elbow<Right>> {
		na::Isometry3::rotation(
		    na::Vector3::z() * right_elbow_roll
		).into()
	}
	...
	pub fn right_ankle_to_tibia(right_ankle_pitch: f32) -> Isometry3<Ankle<Right>, Tibia<Right>> {
		na::Isometry3::new(
		    KNEE_TO_ANKLE,
		    na::Vector3::y() * right_ankle_pitch
		).into()
	}
...
impl From<&JointArray<f32>> for Kinematics {
    fn from(joints: &JointArray<f32>) -> Self {
        Self {
            ...
            right_upper_arm_to_shoulder: Self::right_upper_arm_to_shoulder(joints.right_shoulder_roll),
