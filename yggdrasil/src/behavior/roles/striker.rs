...
pub fn striker_role(
    ...
    let ball_angle = pose.angle_to(&relative_ball);
    let ball_distance = pose.distance_to(&relative_ball);
    let ball_target = Point3::new(relative_ball.x, relative_ball.y, 0.2);
